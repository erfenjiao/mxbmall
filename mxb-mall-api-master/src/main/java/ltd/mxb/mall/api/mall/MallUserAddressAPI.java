...
import ltd.mxb.mall.api.mall.param.SaveMallUserAddressParam;
import ltd.mxb.mall.api.mall.param.UpdateMallUserAddressParam;
import ltd.mxb.mall.api.mall.vo.MallUserAddressVO;
...
@RestController
@Api(value = "v1", tags = "6.mxb 商城个人地址相关接口")
