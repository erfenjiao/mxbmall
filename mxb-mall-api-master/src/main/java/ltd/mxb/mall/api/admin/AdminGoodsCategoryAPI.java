...
import ltd.mxb.mall.api.admin.param.GoodsCategoryAddParam;
import ltd.mxb.mall.api.admin.param.GoodsCategoryEditParam;
 ...
 */
@RestController
@Api(value = "v1", tags = "mxb_mall.后台管理系统分类模块接口")
