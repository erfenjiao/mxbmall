...
import ltd.mxb.mall.api.admin.param.IndexConfigAddParam;
import ltd.mxb.mall.api.admin.param.IndexConfigEditParam;
 ...
 */
@RestController
@Api(value = "v1", tags = "mxb_mall.后台管理系统首页配置模块接口")
...
public class AdminIndexConfigAPI {
    ...
    public Result list(@RequestParam(required = false) @ApiParam(value = "页码") Integer pageNumber,
        ...
        params.put("configType", configType);  // 类型
